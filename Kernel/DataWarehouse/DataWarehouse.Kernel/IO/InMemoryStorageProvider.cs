...
{
    /// <summary>
    /// VOLATILE STORAGE (Internal Utility - Not a Plugin).
    /// Used for testing and temporary storage operations.
    /// Data is lost when the process exits.
    /// For plugin-based RAM storage, use RAMDiskStorageEngine instead.
    /// </summary>
    public class InMemoryStorageProvider : IStorageBackend
    {
        /// <summary>
