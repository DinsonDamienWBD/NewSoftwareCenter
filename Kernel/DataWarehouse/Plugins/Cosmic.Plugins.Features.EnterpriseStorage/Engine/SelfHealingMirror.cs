...
namespace DataWarehouse.Kernel.Drivers
{
    /// <summary>
    ...
    public class SelfHealingMirror(IStorageProvider primary, IStorageProvider secondary, ILogger logger) : IStorageProvider
    {
        ...
        public async Task<Stream> LoadAsync(Uri uri)
        {
            ...
            catch (Exception ex)
            {
                ...
                // DataWarehouse FEATURE: Self-Healing
        ...
        public void ReportFailure(string blobId, string nodeId)
        {
            _repairQueue.Enqueue($"{blobId}@{nodeId}");
        }
